...
- Se o paciente $i$ foi atribuído ao tratamento, então ira exibir o desfecho $r_{T_i}$, mas não exibirá $r_{C_i}$.
- Se o paciente $i$ foi atribuído ao controle, então ira exibir o desfecho $r_{C_i}$, mas não exibirá $r_{T_i}$.
