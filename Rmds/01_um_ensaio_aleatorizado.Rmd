...
- Para o ensaio ProCESS, os lançamentos de moeda destinaram:
    ...
    + 446 $\Rightarrow$ protocolo menos agressivo.
...
\begin{itemize}
\item A chave é que as moedas honestas ignoram os atributos dos pacientes ao atribuir tratamentos a eles.
\end{itemize}
\end{itemize}
\end{alertblock}
